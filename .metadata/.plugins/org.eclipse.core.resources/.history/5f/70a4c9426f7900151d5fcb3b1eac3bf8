...
public class MovieGoerCinemasMenu extends BaseMenu{

	public MovieGoerCinemasMenu(Scanner sc, MovieManager mMovieManager, CinemaManager mCinemaManager,
	...
	public void displayMenu() {
		...
		do {
			printHeader("Options for cinemas");
